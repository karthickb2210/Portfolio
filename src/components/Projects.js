                ...
                <div className='flex-1'>
                  ...
                  <div>
                    {Project.map((service,index)=>{
                     const{name,description } = service;
                      return( 
                        <motion.div variants={fadeIn('left',0.2)} initial="hidden" whileInView={'show'} viewport={{once:false,amount:0.7}} className='border-b border-white/20 h-[146px] mb-[38px]' key={index}>
                      ...
                      {/* <div className='flex flex-col items-end '>
                        <a href='https://github.com/karthickb2210/Integrated-Information-System' className='btn w-12 h-12 mb-[25px]
